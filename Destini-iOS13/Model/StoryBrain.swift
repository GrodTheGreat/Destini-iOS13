...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) {
        if userChoice == stories[storyState].choice1 {
            storyState = stories[storyState].choice1Destination;
        } else if userChoice == stories[storyState].choice2 {
            storyState = stories[storyState].choice2Destination;
        }
    }
};
